...
**État : version de laboratoire à qualifier.** Les tests logiciels ne prouvent ni la précision de la carte réseau, ni le verrouillage de KAIROS, ni une conformité complète SMPTE ST 2059-2. Le protocole d'essai est dans [docs/QUALIFICATION.md](docs/QUALIFICATION.md).
...
Puis suivre [la qualification](docs/QUALIFICATION.md). Des paquets reçus et un état MASTER ne démontrent pas la précision des appareils récepteurs.
